...
commentout
./gspan/gspan -x 8 /home/sira/desktop/rf_for_graph/data/nci/nci_train > ./out/freqpat_maxpat5.out
python ./py/extract_pat.py ./out/freqpat_maxpat5.out > ./out/gf_maxpat5_feat.out
./finder/finder --tran_by_feat=./out/cpdb_train_gf.mat --feat_by_tran=/dev/null ./out/gf_maxpat5_feat.out /home/sira/desktop/rf_for_graph/data/nci/nci_train > /dev/null
./finder/finder --tran_by_feat=./out/cpdb_test_gf.mat --feat_by_tran=/dev/null ./out/gf_maxpat5_feat.out /home/sira/desktop/rf_for_graph/data/nci/nci_test > /dev/null
